...
$result = mysql_query("SELECT Games.game_id, game_name, player_name, start_time FROM Games, Game_Player_Info where game_name = '$game_name' and Games.game_id = Game_Player_Info.game_id and creator_id = player_id");

while($row = mysql_fetch_array($result)){
	echo strtotime($row['start_time']);
